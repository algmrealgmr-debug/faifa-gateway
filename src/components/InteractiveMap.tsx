...
// Component to handle map bounds/filter changes
const MapController = ({ filteredLocations }: { filteredLocations: Location[] }) => {
  const map = useMap();
                ...
                >
                  <Popup>
                    <div className="text-center p-1">
                      ...
                      <br />
                      <span className="text-sm text-gray-500">{location.nameEn}</span>
                    </div>
                  </Popup>
                </Marker>
              ))}
